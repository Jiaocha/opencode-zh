...
export const Definitions = {
  ...
  session_list: keybind("<leader>l", "列出全部会话"),
  ...
  session_toggle_recent: keybind("ctrl+h", "在最近分组中显示或隐藏会话"),
  session_cycle_recent: keybind("<leader>]", "切换到上一个最近会话"),
  session_cycle_recent_reverse: keybind("<leader>[", "切换到下一个最近会话"),
  session_quick_switch_1: keybind("<leader>1", "切换到快捷槽 1 的会话"),
  session_quick_switch_2: keybind("<leader>2", "切换到快捷槽 2 的会话"),
  session_quick_switch_3: keybind("<leader>3", "切换到快捷槽 3 的会话"),
  session_quick_switch_4: keybind("<leader>4", "切换到快捷槽 4 的会话"),
  session_quick_switch_5: keybind("<leader>5", "切换到快捷槽 5 的会话"),
  session_quick_switch_6: keybind("<leader>6", "切换到快捷槽 6 的会话"),
  session_quick_switch_7: keybind("<leader>7", "切换到快捷槽 7 的会话"),
  session_quick_switch_8: keybind("<leader>8", "切换到快捷槽 8 的会话"),
  session_quick_switch_9: keybind("<leader>9", "切换到快捷槽 9 的会话"),
